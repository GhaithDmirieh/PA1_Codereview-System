...
Die Vorgeschlagene Systeme arbeiten hauptsächlich mit dem \ac{VCS} Git und unterstützen alle \ac{CI}/\ac{CD} Tools, haben also Gemeinsamkeiten, jedoch unterscheiden sie sich in anderen Punkten, die in der Tabelle \ref{tab:Vergleichstabelle aller Systeme} dargestellt sind.
...
\begin{table}[h]
	...
	\begin{scriptsize}
		...
		\end{tabular}
	\end{scriptsize}
	\label{Tab:Vergleichstabelle aller Systeme}
\end{table}